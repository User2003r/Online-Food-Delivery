...
export const GET_RESTAURANT_CATEGORY_REQUEST = "GET_RESTAURANT_REQUEST";
export const GET_RESTAURANT_CATEGORY_SUCCESS = "GET_RESTAURANT_SUCCESS";
export const GET_RESTAURANT_CATEGORY_FAILURE = "GET_RESTAURANT_FAILURE";
