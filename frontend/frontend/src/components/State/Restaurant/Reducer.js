import * as actionTypes from "../Restaurant/ActionType";
  ...
  switch (action.type) {
    ...
    case actionTypes.DELETE_RESTAURANT_SUCCESS:
      return {
        ...
        error: null,
        loading: false,
        restaurant: state.restaurant.filter((item) => {
          item.id != action.payload;
        }),
        usersRestaurant: state.usersRestaurant.filter((item) => {
          item.id != action.payload;
        }),
      };
    ...
    case actionTypes.DELETE_EVENTS_SUCCESS:
      return {
        ...
        restaurantEvents: state.restaurantEvents.filter((item) => {
          item.id != action.payload;
        }),
      };
    case actionTypes.CREATE_RESTAURANT_SUCCESS:
